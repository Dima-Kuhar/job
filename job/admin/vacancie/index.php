<?
//====================================================
// Административный модуль раздела 'Вакансии'
...
$site_nav[]=array("name"=>"Вакансии","url"=>"/$document_admin/vacancie/");
...
$db_fields[]=array('employer_id',	'INT',			'Работодатель',	'LISTBOX',	'FILL',	'SHOW ADD',	'SHOW EDIT',	'PREVIEW|LINK',	'');
...
$db_fields[]=array('age_min',		'INT',			'Возраст, от',	'TEXT|3',	'FILL',	'SHOW ADD',	'SHOW EDIT',	'NO PREVIEW',	'Должно быть введено целое число');
$db_fields[]=array('age_max',		'INT',			'Возраст, до',	'TEXT|3',	'FILL',	'SHOW ADD',	'SHOW EDIT',	'NO PREVIEW',	'Должно быть введено целое число');
...
$db_fields[]=array('requirements',	'TEXT|HTML',	'Требования',	'TEXTAREA',	'',		'SHOW ADD',	'SHOW EDIT',	'NO PREVIEW',	'Допускается применение HTML-тегов');
...
// Список для поля 'sex'
$list_sex[0]['value'] = 'a';
$list_sex[0]['name']  = 'не важно';
$list_sex[1]['value'] = 'm';
$list_sex[1]['name']  = 'мужчина';
$list_sex[2]['value'] = 'f';
$list_sex[2]['name']  = 'женщина';
