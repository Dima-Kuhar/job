...

{
	...
	case 'show_form':
...

		{
			...
			echo '<h1 align="center">Редактирование резюме №'.$id.'</h1>'."\n";
...

		{
			...
			echo '<font color="#ff0000"><b>Ошибка:</b> резюме с таким номером не существует</font>'."\n";
	...
	case 'do_update':
...

		{
			...
			if(!$update_data) $error_log[] = 'Не удалось обновить Ваше резюме';
...

			{
				...
				$action_inform='Ваше резюме обновлено';
...

			{
				...
				$action_inform='Извините, в данный момент обновление Вашего резюме невозможно. Сервис будет доступен в течении часа.';
	...
	default:
...

		{
			...
			echo '<h1>Редактирование резюме №'.$id.'</h1>'."\n";
