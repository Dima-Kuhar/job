...
if($rows[0]['sex']=='m') $sex='Мужчина';
elseif($rows[0]['sex']=='f') $sex='Женщина';
elseif($rows[0]['sex']=='a') $sex='Не важно';
...
<tr>
	<td valign="middle" width="120" background="/images/bg-top02-0.gif"><div class="text2"><b>Вакансия:</b></div></td>
...
<tr>
	...
	<td valign="top"><div class="text">от <?=$age_min;?> до <?=$age_max;?> лет</div></td>
</tr>
<?
}
?>
...
<tr>
	<td valign="top" width="133"><div class="text">Требования:</div></td>
...
<?php if($user_login) { ?>
    <table border="0" width="100%" height="25" cellpadding="4" cellspacing="0" background="/images/bg-top02-0.gif">
    <tr>
        <td valign="middle" width="120" background="/images/bg-top02-0.gif"><div class="text2"><b>Работодатель:</b></div></td>
        <td valign="middle" width="2" background="/images/bg-top02-0.gif"><img src="/images/empty.gif" width="2" height="1" border="0" alt=""></td>
        <td valign="middle"><div class="text3"><b>&nbsp;</b></div></td>
    </tr>
    </table>
    ...
    <table border="0" width="" cellpadding="4" cellspacing="0">
    <tr>
        <td valign="top" width="133"><div class="text">Организация:</div></td>
    ...
    <tr>
        <td valign="top" width="133"><div class="text">Контактное лицо:</div></td>
...
if($_GET['frame']!=1){
	...
	print "<br><b><a target=_new style='font-size: 105%;' href='".str_replace("?frame=1","",$_SERVER['REQUEST_URI'])."'>Ссылка на эту вакансию</a></b>
	</div></body></html>";
}
?>