...
// Пользователь удаляет свое резюме
...

{
	...
	if(!$del_result) $action_inform = 'не удалось удалить резюме №$del';

	else $action_inform = 'резюме №'.$del.' успешно удалено';
...

{
...

	{
		...
		echo "\t".'<a href="data-resume-'.$rows[$i]['id'].'.html"><font color="#ff0000">Редактировать</font></a> | <a href="data-allresume-'.$page.'.html?del='.$rows[$i]['id'].'"><font color="#ff0000">Удалить</font></a><br><br>'."\n";
...
<tr>
	...
	<td valign="middle" width="120" background="/images/bg-top02-0.gif"><div class="text2"><b>Ваши резюме:</b></div></td>
